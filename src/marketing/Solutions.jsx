  ...
  const verticals = [
    {
      ...
      highlight:
        "Ideal for owners who want premium automation without rebuilding the home.",
    },
    {
      ...
      highlight:
        "Great for homes that experience frequent power cuts or poor ISP coverage.",
    },
    {
      ...
      highlight:
        "Useful where guest experience cannot depend on public internet quality.",
    },
    {
      ...
      highlight:
        "Perfect for spaces that need predictable behaviour during work hours.",
    },
  ];
